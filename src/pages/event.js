...
const event = () => {
  ...
  <section class = "event">
    ...
    <form class="event_form form" id="event-form" action = "" method = "">    
      ...
      <div class="">
        <textarea name="place" id="place" cols="40" rows="3" placeholder="Lugar"></textarea>        
      </div>
      <div class="">
        <textarea name="description" id="description" cols="40" rows="8" placeholder="Descripcion"></textarea>        
      </div>      
      <div class="">
